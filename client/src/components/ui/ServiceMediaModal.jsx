  ...
  return (
    <div className="fixed inset-0 z-[9999]" onClick={onClose}>
      ...
      <div
        ...
        className="fixed left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 w-[92%] sm:w-[90%] max-w-xl bg-[#FDFBF7] dark:bg-dark-900 border-2 border-[#D4AF37] rounded-3xl shadow-2xl overflow-y-auto"
      ...
      >
        <div className="flex items-center justify-between px-3 sm:px-6 pt-3 sm:pt-5 pb-3 border-b border-ivory-200 dark:border-dark-700">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            <div className="w-6 h-6 sm:w-10 sm:h-10 rounded-full bg-champagne-400/10 border border-[#D4AF37] flex items-center justify-center shrink-0">
              <Info className="w-3 h-3 sm:w-5 sm:h-5 text-[#D4AF37]" />
            </div>
          ...
          <button
            onClick={onClose}
            className="w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center bg-black/10 dark:bg-white/10 text-dark-600 dark:text-ivory-200 hover:bg-black/20 transition-colors shrink-0 ml-2"
          >
