  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black/70 flex items-center justify-center" onClick={onClose}>
      <div
        ...
        className="w-[92%] sm:w-full max-w-2xl bg-[#FDFBF7] dark:bg-dark-900 border-2 border-[#D4AF37] rounded-3xl shadow-2xl overflow-y-auto"
        style={{ maxHeight: '85vh' }}
        dir={isRtl ? 'rtl' : 'ltr'}
      >
        <div className="flex items-center justify-between px-4 sm:px-6 pt-3 sm:pt-5 pb-3 border-b border-ivory-200 dark:border-dark-700">
