  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70" onClick={onClose}>
      <div
        ...
        dir={isRtl ? 'rtl' : 'ltr'}
      >
        <div className="flex items-center justify-between px-4 sm:px-6 pt-4 sm:pt-5 pb-3 border-b border-ivory-200 dark:border-dark-700 shrink-0">
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-full flex items-center justify-center bg-black/10 dark:bg-white/10 text-dark-600 dark:text-ivory-200 hover:bg-black/20 transition-colors shrink-0"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="shrink-0 px-4 sm:px-6 pb-4 sm:pb-5 pt-3 border-t border-ivory-200 dark:border-dark-700">
