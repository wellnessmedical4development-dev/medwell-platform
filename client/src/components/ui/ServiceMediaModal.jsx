...
export default function ServiceMediaModal({ isOpen, onClose, service, getTitle }) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black/70 flex items-center justify-center p-3 sm:p-4" onClick={onClose}>
      <div
        onClick={(e) => e.stopPropagation()}
        className="relative w-full max-w-2xl bg-[#FDFBF7] dark:bg-dark-900 border-2 border-[#D4AF37] rounded-3xl shadow-2xl overflow-y-auto"
        style={{ maxHeight: '90vh' }}
        dir={isRtl ? 'rtl' : 'ltr'}
      >
        <div className="sticky top-0 z-10 bg-[#FDFBF7] dark:bg-dark-900 flex items-center justify-between px-4 sm:px-6 pt-3 sm:pt-5 pb-3 border-b border-ivory-200 dark:border-dark-700">
        ...
        <div className="px-4 sm:px-6 pb-3 sm:pb-5 pt-3 border-t border-ivory-200 dark:border-dark-700">
